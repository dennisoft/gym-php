...
if ( isset( $_SESSION['id'] ) ) {
    require_once ('app/payment/fetch-details-api.php');
    $response = getPayments( $_SESSION['id']);
}
...
<head>
    ...
    <title>DataTables buttons &middot; Elephant Template &middot; The fastest way to build Modern Admin APPS for any platform, browser, or device.</title>
        ...
        <div class="navbar-toggleable">
            <nav id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" href="datatables-buttons.html#" role="button" data-toggle="dropdown" aria-haspopup="true">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                            ...
                            <div class="dropdown-body">
                                <div class="list-group list-group-divided custom-scrollbar">
                                    <a class="list-group-item" href="datatables-buttons.html#">
                            ...
                            <div class="dropdown-footer">
                                <a class="dropdown-btn" href="datatables-buttons.html#">See All</a>
                            </div>
                        </div>
                    </li>
                    <li class="dropdown">
                  ...
                  <span class="icon-with-child hidden-xs">
                    ...
                    Notifications
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                            <div class="dropdown-header">
                                <a class="dropdown-link" href="datatables-buttons.html#">Mark all as read</a>
                ...
                <span class="d-ib">Payments and Subscriotion
                </span>
                        <span class="d-ib">
                  <a class="title-bar-shortcut" href="datatables-buttons.html#" title="Add to shortcut list" data-container="body" data-toggle-text="Remove from shortcut list" data-trigger="hover" data-placement="right" data-toggle="tooltip">
                    <span class="sr-only">Add to shortcut list</span>
                  </a>
                </span>
                    </h1>
                    <p class="title-bar-description">
                        <small>Manage your subscription and make paymnts</a>.</small>
                    </p>
                </div>
            </nav>
        </div>
...
<!--                                    <th>MPESA Receipt</th>-->
                                ...
                                <?php
                                for ($x = 0; $x <= sizeof($response['subscriptionDetails']) - 1; $x++) {
                                    echo "<tr>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['receiptNumber']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['amount']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['paidAmount']."</td>";
//                                    echo "<td>".$response['subscriptionDetails'][$x]['mpesaReceipt']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['paymentDate']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['paymentStatus']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['responseCode']."</td>";
                                    echo "<td>".$response['subscriptionDetails'][$x]['responseDesc']."</td>";
                                    echo "<tr>";
            ...
            <div class="row gutter-xs">
                <div class="col-xs-12 col-sm-4">
                    <form method="POST" action="app/payment/pay-api-client.php">
                        <div class="form-group">
                            <label class="control-label">Amount (Kshs) </label>
                            <input class="form-control" type="text" name="amount" required>
                        </div>
                        <button class="btn btn-success btn-block btn-next" type="submit" name="current_submit" id="current_submit">Make Payment</button>
                    </form>
                </div>
            </div>
