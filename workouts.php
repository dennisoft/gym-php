...
if ( isset( $_SESSION['id'] ) ) {
    require_once ('app/workout/fetch-details-api.php');
    ...
    <div class="navbar navbar-default">
        ...
        <div class="navbar-toggleable">
            <nav id="navbar" class="navbar-collapse collapse">
                ...
                <span class="d-ib">Workout Manager
                </span>
                        <span class="d-ib">
                  <a class="title-bar-shortcut" href="datatables-buttons.html#" title="Add to shortcut list" data-container="body" data-toggle-text="Remove from shortcut list" data-trigger="hover" data-placement="right" data-toggle="tooltip">
                    ...
                    <p class="title-bar-description">
                        <small>View my workout schedule as assigned by trainer</a>.</small>
                    </p>
                </div>
            </nav>
        </div>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <strong>My WorkOut Schedule</strong>
                        </div>
                        <div class="card-body">
                            <table id="demo-datatables-buttons-1" class="table table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                                ...
                                <?php
                                for ($x = 0; $x <= sizeof($response['workOutDetails']) - 1; $x++) {
                                    echo "<tr>";
                                    echo "<td>".$response['workOutDetails'][$x]['workID']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['activity']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['day']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['sets']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['reps']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['kg']."</td>";
                                    echo "<td>".$response['workOutDetails'][$x]['restTime']."</td>";
                                    echo "<tr>";
                                }
                                ?>
...
<!--            <button class="btn btn-success" data-toggle="modal" data-target="#modalSignUpSm" type="button">Make New Payment</button>-->
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h4 class="modal-title">Renew your memebership</h4>
                </div>
                <div class="modal-body">
                    <form>
                        ...
                        <button class="btn btn-success btn-block btn-next" type="button">Make Payment</button>
                    </form>
                </div>
            </div>
        </div>
